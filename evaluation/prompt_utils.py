TASK_TO_PROMPT = {
    "tha": {
        ...
        "IC": ["Caption the following image in [LANGUAGE]."],
        # Tasks.VISUAL_QUESTION_ANSWERING
        "VQA": ["[IMAGE] Based on the image, [QUESTION]"],
...
LABEL_LANG_MAP = {
    ...
    "wisesight_thai_sentiment_seacrowd_text": {
        "eng": {
            ...
            "neu": "neutral",
            "neg": "negative",
            "q": "not applicable (question)",
        },
        "ind": {
            "pos": "positif",
            "neu": "netral",
            "neg": "negatif",
            "q": "tidak berlaku (pertanyaan)",
        },
    },
    ...
    "nusaparagraph_topic_btk_seacrowd_text": {
        ...
        "ind": {
            ...
            "sports": "olahraga",
            "leisures": "aktivitas santai",
            "religion": "agama",
            "culture & heritage": "kebudayaan & sejarah",
    ...
    "wrete_seacrowd_pairs": {
        ...
        "ind": {
            "NotEntail": "saling berlawanan",
            "Entail_or_Paraphrase": "saling mendukung",
        },
    },
    "snli_indo_seacrowd_pairs": {
        ...
        "ind": {
            "kontradiksi": "saling berlawanan",
            "keterlibatan": "saling mendukung",
            "netral": "tidak berhubungan",
        },
    },
    "myxnli_seacrowd_pairs": {
        ...
        "ind": {
            "contradiction": "saling berlawanan",
            "entailment": "saling mendukung",
            "neutral": "tidak berhubungan",
        },
    },
